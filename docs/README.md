...
| [configurable-workflows.md](./configurable-workflows.md)   | Roadmap for the user-configurable workflow engine (interpreter, gates, fan-out, editor, shell steps) | **Living** — phases 1–3 shipped (PRs #13, #14, #15); 3.5 and 4–7 pending |
