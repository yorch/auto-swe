...
| **[architecture.md](./architecture.md)** | **Current** | System context, package map with file references, request lifecycle, workflow engine (12 node types), runtime security scanners, budget tiers, auth, data model, infra diagrams |
...
agent-workflow platform (SWE becomes seed content). **P0 + P1 are implemented; P2 is underway.**
