...
| **[architecture.md](./architecture.md)** | **Current** | System context, package map with file references, request lifecycle, workflow engine (13 node types), runtime security scanners, budget tiers, auth, data model, infra diagrams |
