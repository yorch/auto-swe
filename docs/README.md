...
| [model-configuration.md](./model-configuration.md)         | DB-backed LLM model + provider credential config: scope cascade, encryption, day-2 ops, troubleshooting | **Living** — Phase 4 shipped |
