...
| Domain | Capabilities |
|---|---|
| **Agent system** | 27 seeded agents (16 model-backed + 11 sub-role personas); multi-agent review network; TDD implementation loop; channel-resident assistant with ambient, reactive, and persona modes. See [agents.md](./agents.md). |
