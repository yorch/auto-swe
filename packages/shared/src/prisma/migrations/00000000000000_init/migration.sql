...
-- CreateTable
CREATE TABLE "workflow_outcome_references" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "run_id" UUID NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "workflow_outcome_references_run_id_node_id_connection_id_at_key" ON "workflow_outcome_references"("run_id", "node_id", "connection_id", "attempt");
...
-- CreateIndex
CREATE UNIQUE INDEX "workflow_steps_run_id_node_id_attempt_key" ON "workflow_steps"("run_id", "node_id", "attempt");
...
-- CreateIndex
CREATE INDEX "autonomy_policies_team_id_idx" ON "autonomy_policies"("team_id");
...
-- AddForeignKey
ALTER TABLE "autonomy_policies" ADD CONSTRAINT "autonomy_policies_template_id_fkey" FOREIGN KEY ("template_id") REFERENCES "workflow_templates"("id") ON DELETE CASCADE ON UPDATE CASCADE;
