...
export const SIGNAL_GATED_ROLLOUT_SPEC: WorkflowSpec = {
  ...
  nodes: {
    ...
    checkDeployGate: {
      ...
      onFalse: 'terminateDeployRejected',
      onTrue: 'done',
      type: 'cond',
    },
    checkReviewLimit: {
    ...
    waitForDeployGate: {
      name: 'deploymentGateSignal',
      onReceive: 'checkDeployGate',
      onTimeout: 'terminateDeployTimedOut',
